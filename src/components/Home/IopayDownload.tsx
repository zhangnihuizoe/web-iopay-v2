...
const DesktopItem = ({ href, ...restProps }) => (
  <chakra.a
    href={href}
    display="flex"
    alignItems="center"
...
const IopayDownload = observer((props) => {
  ...
  return (
    <Box {...props}>
      <Box mt="5">
        <Text
          fontSize={{ base: "1.2rem", xl: "1.55rem", "2xl": "1.75rem" }}
          opacity={0.6}
        >
          {lang.t(`iopay.mobile`)}
        </Text>
        ...
        >
          <DesktopItem href={packages?.mac}>
            <Image
              ...
              h="32px"
              mr="8px"
              src="/images/iopay/iopay_mac.svg"
              alt=""
            />
            MacOS
          </DesktopItem>
          <DesktopItem href={packages?.window}>
            <Image
              ...
              h="32px"
              mr="8px"
              src="/images/iopay/iopay_windows.svg"
              alt=""
            />
            Windows
          </DesktopItem>
          <DesktopItem href={packages?.linux}>
            <Image
              w="32px"
              h="32px"
              mr="8px"
              src="/images/iopay/iopay_linux.svg"
              alt=""
            />
            Linux
          </DesktopItem>
	  ...
	  <Box mt="5">
        ...
        <SimpleGrid
          ...
          spacingX={{ xl: 2 }}
        >
          <DesktopItem href={publicConfig.IOPAY_WEB_URL}>
            <Image
              w="24px"
              h="24px"
              mr="12px"
              src="/images/iopay/iopay_web.svg"
              alt=""
            />
            Beta
          </DesktopItem>
