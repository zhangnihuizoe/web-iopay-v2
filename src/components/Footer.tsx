...
export const Footer = observer(() => {
  ...
  const config = [
    {
      ...
      lists: [
        ...
        },
        {
          ...
          blank: true,
          icon: "images/iopay/icon_map_n.png",
          icon_active: "images/iopay/icon_map_s.png",
        },
        {
...

    {
      ...
      lists: [
        ...
        },
        {
          ...
          blank: true,
          icon: "images/iopay/icon_stake_n.png",
          icon_active: "images/iopay/icon_stake_s.png",
        },
        {
          name: lang.t("burn.drop"),
          path: "https://burndrop.iotex.io/",
          blank: true,
          icon: "images/iopay/icon_brun-drop_n.png",
          icon_active: "images/iopay/icon_brun-drop_n.png",
        },
        {
          name: lang.t("explore"),
          path: "https://iotexscan.io/",
          blank: true,
          icon: "images/iopay/icon_explorer_n.png",
          icon_active: "images/iopay/icon_explorer_s.png",
        },
      ],
    },
    {
      ...
      lists: [
        {
          ...
          blank: true,
          icon: "images/iopay/icon_gitHub_n.png",
          icon_active: "images/iopay/icon_gitHub_s.png",
        },
        {
          name: lang.t("dev.docs"),
          path: "https://docs.iotex.io/",
          blank: true,
          icon: "images/iopay/icon_docs_n.png",
          icon_active: "images/iopay/icon_docs_s.png",
        },
        {
          name: lang.t("halo.grants"),
          path: "https://iotex.io/halo",
          blank: true,
          icon: "images/iopay/icon_halo_n.png",
          icon_active: "images/iopay/icon_halo_s.png",
        },
      ],
    },
    {
      ...
      lists: [
        {
          ...
          blank: true,
          icon: "images/iopay/icon_ecopage_n.png",
          icon_active: "images/iopay/icon_ecopage_s.png",
        },
        {
          name: lang.t("live.ioTT.network"),
          path: "https://iott.network/",
          blank: true,
          icon: "images/iopay/icon_iott_n.png",
          icon_active: "images/iopay/icon_iott_s.png",
        },
        {
          name: lang.t("blog"),
          path: "https://iotex.io/blog",
          blank: true,
          icon: "images/iopay/icon_blog_n.png",
          icon_active: "images/iopay/icon_blog_s.png",
        },
      ],
    },
  ];
  ...
  const links = [
    {
      icon: "images/iopay/icon_twitter_n.png",
      icon_active: "images/iopay/icon_twitter_s.png",
      blank: true,
      href: "https://twitter.com/iotex_io",
    },
    {
      icon: "images/iopay/icon_discord_n.png",
      icon_active: "images/iopay/icon_discord_s.png",
      blank: true,
      href: "https://iotex.io/devdiscord",
    },
    {
      icon: "images/iopay/icon_youtube_n.png",
      icon_active: "images/iopay/icon_youtube_s.png",
      blank: true,
      href: "https://www.youtube.com/channel/UCdj3xY3LCktuamvuFusWOZw",
    },
    {
      icon: "images/iopay/icon_reddit_n.png",
      icon_active: "images/iopay/icon_reddit_s.png",
      blank: true,
      href: "https://www.reddit.com/r/IoTeX/",
    },
    {
      icon: "images/iopay/icon_telegram_n.png",
      icon_active: "images/iopay/icon_telegram_s.png",
      blank: true,
    ...
    >
      ...
      >
        ...
        >
          ...
          <Box mt="0.5rem">
            {loading && (
              <Text color="discord" fontSize="0.75rem">
                {lang.t("loading")}
              </Text>
            )}
            {success && (
      ...
      <Link href={"https://iotex.io/policy"} _hover={{}}>
        <Text
          color="footerContent"
